...
#############################################################################################
#Script Name   :release_image_3_0.sh                                                              
#Author        :DIVAGAR N                                                
...
sudo docker run -it -w /haystack_ws/ -d --env /opt/ros/noetic/setup.bash --privileged --name "haystack" nimbushaystack/haystack_noetic_image_base:v0.0 top
